...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/HumanResourceManagement/listassignedwork" class="logo d-flex align-items-center">
        <img src="" alt="">
        <span class="d-none d-lg-block"> <i class="bx bx-group"></i> Công ty ABC</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3"><a
				...
				data-bs-toggle="dropdown"> <img
					src="${url}/assets/img/2021603374.jpg" alt="Profile"
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li><a class="dropdown-item d-flex align-items-center"
						href="/HumanResourceManagement/logoutAdmin"> <i class="bi bi-box-arrow-right"></i> <span>Sign Out</span>
					</a></li>
